...
#define HOTEND_OFFSET_X {0.0, -33.4} // (in mm) for each extruder, offset of the hotend on the X axis
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 59.5
  #define DEFAULT_Ki 6.463
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 858 }
